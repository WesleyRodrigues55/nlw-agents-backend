...
export async function generateEmbenddings(text: string) {
...
export async function generateAnswer(
  ...
  const prompt = `
    Com base no texto fornecido abaixo como um contexto, responda a pergunta de forma clara e precisa em português do Brasil.
    ...
    - Seja objetivo;
    - Mantenha um tom educativo e educacional;
